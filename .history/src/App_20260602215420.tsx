...
// Orquestador de toda la aplicación. Se encarga de:
//   1. Cargar los datos de Supabase al iniciar (useEffect)
//   2. Guardar el estado global de departamentos y empleados (useState)
//   3. Controlar qué modal está abierto (useState)
//   4. Pasar datos y funciones a los componentes hijos via props
...
function App() {
  // ── Estado global: listas de datos ──────────────────────────
  const [departamentos, setDepartamentos] = useState<Departamento[]>([]);
  const [empleados, setEmpleados] = useState<Empleado[]>([]);

  // ── Estado global: control de modales ───────────────────────
  // null = modal cerrado | objeto = modal abierto con ese registro
