...
// Muestra la lista de empleados con opciones de editar y eliminar.
// Props:
//   empleados     → lista de empleados a mostrar
//   departamentos → lista de departamentos para resolver el nombre por FK
//   onEdit        → abre el modal de edición con el empleado seleccionado
